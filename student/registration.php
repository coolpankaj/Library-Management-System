	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-md-offset-3">
				...
				<form name="registration" action="s_registration.php" method="POST">
					...
					<div class="form-group">
						<!-- <div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div> -->
						<input type="text" name="enrollmentno" class="form-control" placeholder="Enrollment number" required="" />
					</div>
					<div class="form-group">
